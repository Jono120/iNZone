...
{
	public partial class ScreenSaverVideos : System.Web.UI.Page
	{
		...
		{
			string partnerConfigFilePath = Server.MapPath("~/" + ConfigurationManager.AppSettings["VideosFolderName"]) + "/" + "NZArmy101" + "/Config.xml";
			base.OnInit(e);
		}
		...
		private void SetupHeader()
		{
			...
			string partnerName = "NZArmy101";
			int selectedVideoID = 5;
		...
		private void SetupSessionVariables()
		{
			...
			Session["PartnerName"] = "NZArmy101";

			//Category of partner
			//Session["Category"] = Request.QueryString["Cat"];
			Session["Category"] = "Careers";
