...
{
	public partial class ScreenSaverWhaleWatch : System.Web.UI.Page
	{
		...
		{
			string partnerConfigFilePath = Server.MapPath("~/" + ConfigurationManager.AppSettings["VideosFolderName"]) + "/" + "SSWhaleWatch" + "/Config.xml";
			base.OnInit(e);
		}
		...
		private void SetupHeader()
		{
			...
			string partnerName = "SSWhaleWatch";
