		...
		<table border="1" cellpadding="0" cellspacing="0" style='width: 100.0%; border: 0px'
			...
			<tr>
				<td style='width: 100.0%; border-top: solid windowtext 2.25pt; border-left: none;
					...
					<p class="MsoNormal" style='margin-bottom: 0in; margin-bottom: .0001pt; line-height: normal'>
						<b><span style='color: white'>Register Event</span></b></p>
				</td>
			</tr>
			<tr>
				<td style='border: 0px;'>
			...
			<tr>
				<td style="padding-right: 5.4pt; padding-left: 5.4pt; padding-bottom: 0in; border-top-style: none;
					...
					<asp:TextBox ID="txtEventName" runat="server" Width="276px"></asp:TextBox><br />
					<strong>Event Date</strong>&nbsp;<i>Please enter in format: dd-mmm-yyyy</i><br />
					<asp:TextBox ID="txtEventDate" runat="server" Width="276px"></asp:TextBox>
					<br />
					<asp:Button ID="btnRegisterEvent" runat="server" OnClick="btnRegisterEvent_Click"
						Text="Register Event" /><br />
					<br />
					<asp:Label ID="lblStatus" runat="server" Font-Names="Arial" Font-Size="10pt" Text=""></asp:Label><br />
					<br />
